...
def start_server(web_app_dir: str, port: int) -> subprocess.Popen:
    ...
    return subprocess.Popen(
        ...
        cwd=web_app_dir,
        # Do not pipe output unless something drains it. The app servers log
        # API requests; an unread pipe can fill up and block the server thread,
        # which then makes /api/reset hang forever.
